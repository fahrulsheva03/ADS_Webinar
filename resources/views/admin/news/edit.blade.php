...
@section('content')
    <main id="main-content" tabindex="-1" class="pb-4" role="main" aria-label="Edit berita">
        <div class="d-flex flex-wrap align-items-start justify-content-between gap-3 mb-4">
            <div class="me-auto">
                <h1 class="h3 mb-1">Edit Berita</h1>
                <div class="text-muted">Perbarui konten, gambar, kategori, dan status publikasi.</div>
            </div>
                    ...
                    <div class="col-12 col-lg-8">
                        ...
                        <div class="mb-3">
                            ...
                            @error('slug')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @else
                                <div class="form-text">Ubah slug bila diperlukan. Gunakan huruf kecil, angka, dan tanda minus.</div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-lg-6">
                                ...
                                <textarea
                                    ...
                                    rows="3"
                                    maxlength="255"
                                >{{ old('meta_keywords', $news->meta_keywords) }}</textarea>
                                @error('meta_keywords')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="mb-3">
                            ...
                            >
                                ...
                                @foreach ($categories as $c)
                                    <option
                                        value="{{ $c->id }}"
                                        @selected((string) old('news_category_id', (string) $news->news_category_id) === (string) $c->id)
                                    >
                                        {{ $c->nama }}
                                    </option>
                                @endforeach
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">
                                @if ($news->published_at)
                                    Terakhir publish: {{ optional($news->published_at)->format('d M Y H:i') }}
                                @else
                                    Belum dipublish.
                                @endif
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            @error('gambar_utama')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">Pilih gambar baru jika ingin mengganti (maks 2MB).</div>
                        </div>
